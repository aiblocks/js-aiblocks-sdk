...
describe('server.js non-transaction tests', function() {
  beforeEach(function() {
    this.server = new AiBlocksSdk.Server(
      'https://millennium-live.aiblocks.io:1337'
    );
  ...
  describe('Server.constructor', function() {
    it('throws error for insecure server', function() {
      expect(
        () => new AiBlocksSdk.Server('http://millennium-live.aiblocks.io:1337')
      ).to.throw(/Cannot connect to insecure millennium server/);
    });
  ...
  describe('Server.fetchTimebounds', function() {
    ...
    beforeEach(function() {
      ...
      this.axiosMockAdapter = new MockAdapter(MillenniumAxiosClient);
    });
    ...
    it('fetches falls back to local time if fetch is bad', function(done) {
      this.axiosMockAdapter
        .onGet('https://millennium-live.aiblocks.io:1337/')
        .reply(200, {}, {});
  ...
  describe('Server.fetchBaseFee', function() {
    ...
    it('returns the base reserve', function(done) {
      this.axiosMock
        .expects('get')
        .withArgs(sinon.match('https://millennium-live.aiblocks.io:1337/fee_stats'))
  ...
  describe('Server.loadAccount', function() {
    ...
    let accountResponse = {
      "_links": {
        "self": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS"
        },
        "transactions": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/transactions{?cursor,limit,order}",
          "templated": true
        },
        "operations": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/operations{?cursor,limit,order}",
          "templated": true
        },
        "payments": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/payments{?cursor,limit,order}",
          "templated": true
        },
        "effects": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/effects{?cursor,limit,order}",
          "templated": true
        },
        "offers": {
          "href": "https://millennium-testnet.aiblocks.io/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS/offers{?cursor,limit,order}",
          "templated": true
        }
      },
    ...
    it('returns AccountResponse object', function(done) {
      this.axiosMock
        ...
        .withArgs(
          sinon.match(
            'https://millennium-live.aiblocks.io:1337/accounts/GBAH7FQMC3CZJ4WD6GE7G7YXCIU36LC2IHXQ7D5MQAUO4PODOWIVLSFS'
          )
        )
      ...
      describe('without options', function() {
        it('requests the correct endpoint', function(done) {
          this.axiosMock
            .expects('get')
            .withArgs(
              sinon.match('https://millennium-live.aiblocks.io:1337/ledgers')
            )
      ...
      describe('with options', function() {
        beforeEach(function() {
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                'https://millennium-live.aiblocks.io:1337/ledgers?limit=1&cursor=b&order=asc'
              )
            )
            .returns(Promise.resolve({ data: ledgersResponse }));
        });
        ...
        it('can call .next() on the result to retrieve the next page', function(done) {
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                'https://millennium-live.aiblocks.io:1337/ledgers?order=asc&limit=1&cursor=4294967296'
              )
            )
            .returns(Promise.resolve({ data: ledgersResponse }));
      ...
      describe('for a non existent ledger', function() {
        it('throws a NotFoundError', function(done) {
          this.axiosMock
            .expects('get')
            .withArgs(
              sinon.match('https://millennium-live.aiblocks.io:1337/ledgers/1')
            )
      ...
      describe('with options', function() {
        it('requests the correct endpoint', function(done) {
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                'https://millennium-live.aiblocks.io:1337/ledgers/1?limit=1&cursor=b&order=asc'
              )
            )
            .returns(Promise.resolve({ data: singleLedgerResponse }));
    ...
    describe('requests a sub resource', function(done) {
      let transactionsResponse = {
        _links: {
          self: {
            href:
              'https://millennium.aiblocks.io/transactions?order=desc\u0026limit=1\u0026cursor='
          },
          next: {
            href:
              'https://millennium.aiblocks.io/transactions?order=desc\u0026limit=1\u0026cursor=34156680904183808'
          },
          prev: {
            href:
              'https://millennium.aiblocks.io/transactions?order=asc\u0026limit=1\u0026cursor=34156680904183808'
          }
        },
        _embedded: {
          records: [
            {
              _links: {
                self: {
                  href:
                    'https://millennium.aiblocks.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1'
                },
                account: {
                  href:
                    'https://millennium.aiblocks.io/accounts/GBURK32BMC7XORYES62HDKY7VTA5MO7JYBDH7KTML4EPN4BV2MIRQOVR'
                },
                ledger: {
                  href: 'https://millennium.aiblocks.io/ledgers/7952722'
                },
                operations: {
                  href:
                    'https://millennium.aiblocks.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/operations{?cursor,limit,order}',
                  templated: true
                },
                effects: {
                  href:
                    'https://millennium.aiblocks.io/transactions/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1/effects{?cursor,limit,order}',
                  templated: true
                },
                precedes: {
                  href:
                    'https://millennium.aiblocks.io/transactions?order=asc\u0026cursor=34156680904183808'
                },
                succeeds: {
                  href:
                    'https://millennium.aiblocks.io/transactions?order=desc\u0026cursor=34156680904183808'
                }
              },
              id:
      ...
      describe('without options', function() {
        it('requests the correct endpoint', function(done) {
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                'https://millennium-live.aiblocks.io:1337/ledgers/7952722/transactions'
              )
            )
          ...
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                /^https:\/\/millennium.aiblocks.io\/transactions\/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1\/operations/
              )
            )
      ...
      describe('with options', function() {
        it('requests the correct endpoint', function(done) {
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                'https://millennium-live.aiblocks.io:1337/ledgers/7952722/transactions?cursor=b&limit=1&order=asc'
              )
            )
            .returns(Promise.resolve({ data: transactionsResponse }));
          ...
          this.axiosMock
            ...
            .withArgs(
              sinon.match(
                /^https:\/\/millennium.aiblocks.io\/transactions\/c585b8764b28be678c482f8b6e87e76e4b5f28043c53f4dcb7b724b4b2efebc1\/operations\?limit=1/
              )
            )
            .returns(Promise.resolve({ data: { operations: [] } }));
    ...
    describe('TransactionCallBuilder', function() {
      ...
      it('#transaction - requests the correct endpoint', function(done) {
        let singleTranssactionResponse = {
          "_links": {
            "self": {
              "href": "https://millennium-testnet.aiblocks.io/transactions/6bbd8cbd90498a26210a21ec599702bead8f908f412455da300318aba36831b0"
            },
            "account": {
              "href": "https://millennium-testnet.aiblocks.io/accounts/GBCCHT5P34DMK2LTN4SPHBAJCXYFNUEWSM7SDSWEXJA7NN6CA3HNHTM6"
            },
            "ledger": {
              "href": "https://millennium-testnet.aiblocks.io/ledgers/121879"
            },
            "operations": {
              "href": "https://millennium-testnet.aiblocks.io/transactions/6bbd8cbd90498a26210a21ec599702bead8f908f412455da300318aba36831b0/operations{?cursor,limit,order}",
              "templated": true
            },
            "effects": {
              "href": "https://millennium-testnet.aiblocks.io/transactions/6bbd8cbd90498a26210a21ec599702bead8f908f412455da300318aba36831b0/effects{?cursor,limit,order}",
              "templated": true
            },
            "precedes": {
              "href": "https://millennium-testnet.aiblocks.io/transactions?order=asc&cursor=523466319077376"
            },
            "succeeds": {
              "href": "https://millennium-testnet.aiblocks.io/transactions?order=desc&cursor=523466319077376"
            }
          },
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/transactions/6bbd8cbd90498a26210a21ec599702bead8f908f412455da300318aba36831b0'
            )
          )
    ...
    describe('AccountCallBuilder', function() {
      ...
      it('requests the correct endpoint', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K'
            )
          )
      ...
      it('adds a "signer" query to the endpoint', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts?signer=GBCR5OVQ54S2EKHLBZMK6VYMTXZHXN3T45Y6PRX4PX4FXDMJJGY4FD42'
            )
          )
      ...
      it('adds an "asset" query to the endpoint', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts?asset=USD%3AGDGQVOKHW4VEJRU2TETD6DBRKEO5ERCNF353LW5WBFW3JJWQ2BRQ6KDD'
            )
          )
        ...
        this.server
          .accounts()
          .forAsset(new AiBlocksSdk.Asset('USD','GDGQVOKHW4VEJRU2TETD6DBRKEO5ERCNF353LW5WBFW3JJWQ2BRQ6KDD'))
          .call()
          .then(function(response) {
            expect(response.records).to.be.deep.equal(
      ...
      it('adds a "sponsor" query to the endpoint', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts?sponsor=GBCR5OVQ54S2EKHLBZMK6VYMTXZHXN3T45Y6PRX4PX4FXDMJJGY4FD42'
            )
          )
    ...
    describe('OfferCallBuilder', function() {
      ...
      it('without params requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/offers?order=asc'
            )
          )
      ...
      it('single offer requests the correct endpoint', function(done) {
        const offerResponse = {
          "_links": {
            "self": {
              "href": "https://millennium.aiblocks.io/offers/12345"
            },
            "offer_maker": {
              "href": "https://millennium.aiblocks.io/accounts/GCK4WSNF3F6ZNCMK6BU77ZCZ3NMF3JGU2U3ZAPKXYBKYYCJA72FDBY7K"
            }
          },
          "id": 12345,
          "paging_token": "12345",
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/offers/12345'
            )
          )
      ...
      it('forAccount requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/offers?order=asc'
            )
          )
          .returns(Promise.resolve({ data: offersResponse }));
      ...
      it('selling requests the correct endpoint', function(done) {
        const selling = new AiBlocksSdk.Asset(
          'USD',
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/offers?selling_asset_type=credit_alphanum4&selling_asset_code=USD&selling_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&order=asc'
            )
          )
          .returns(Promise.resolve({ data: offersResponse }));
      ...
      it('buying requests the correct endpoint', function(done) {
        const buying = new AiBlocksSdk.Asset(
          'COP',
          'GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG'
        );
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/offers?buying_asset_type=credit_alphanum4&buying_asset_code=COP&buying_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&order=asc'
            )
          )
          .returns(Promise.resolve({ data: offersResponse }));
      ...
      it('sponsor requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/offers?sponsor=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&order=asc'
            )
          )
          .returns(Promise.resolve({ data: offersResponse }));
    ...
    describe('OrderbookCallBuilder', function() {
      ...
      it('requests the correct endpoint native/credit', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=USD&buying_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG'
            )
          )
        ...
        this.server
          .orderbook(
            AiBlocksSdk.Asset.native(),
            new AiBlocksSdk.Asset(
              'USD',
              'GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG'
            )
          )
      ...
      it('requests the correct endpoint credit/native', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/order_book?selling_asset_type=credit_alphanum4&selling_asset_code=USD&selling_asset_issuer=GDVDKQFP665JAO7A2LSHNLQIUNYNAAIGJ6FYJVMG4DT3YJQQJSRBLQDG&buying_asset_type=native'
            )
          )
          .returns(Promise.resolve({ data: orderBookResponse }));
      ...
      it('trades() requests the correct endpoint (no filters)', function(done) {
        let tradesResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=asc&limit=200&cursor='
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=asc&limit=200&cursor=64199539053039617-0'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=desc&limit=200&cursor=64199539053039617-0'
            }
          },
          _embedded: {
            records: [
              {
                _links: {
                  base: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GB7JKG66CJN3ACX5DX43FOZTTSOI7GZUP547I3BSXIJVUX3NRYUXHE6W'
                  },
                  counter: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GC6APVH2HCFB7QLSTG3U55IYSW7ZRNSCTOZZYZJCNHWX2FONCNJNULYN'
                  },
                  operation: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/operations/64199539053039617'
                  }
                },
        ...
        this.axiosMock
          .expects('get')
          .withArgs(sinon.match('https://millennium-live.aiblocks.io:1337/trades'))
      ...
      it('trades() requests the correct endpoint for assets', function(done) {
        let tradesResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=asc&limit=10&cursor='
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=asc&limit=10&cursor=64199539053039617-0'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM&order=desc&limit=10&cursor=64199539053039617-0'
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/trades?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=JPY&counter_asset_issuer=GBVAOIACNSB7OVUXJYC5UE2D4YK2F7A24T7EE5YOMN4CE6GCHUTOUQXM'
            )
          )
          .returns(Promise.resolve({ data: tradesResponse }));
      ...
      it('trades() requests the correct endpoint for offer', function(done) {
        let tradesResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?offer_id=278232&order=asc&limit=10&cursor='
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?offer_id=278232&order=asc&limit=10&cursor=64199539053039617-0'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?offer_id=278232&order=desc&limit=10&cursor=64199539053039617-0'
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/trades?offer_id=278232'
            )
          )
          .returns(Promise.resolve({ data: tradesResponse }));
      ...
      it('trades() requests the correct endpoint for account', function(done) {
        let tradesResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/accounts/GABJBA4HI4LVKWAYORE7SOAAZMVXDHI566JBSD25O5TRDM7LVID6YOXY/trades?cursor=&limit=10&order=asc'
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/accounts/GABJBA4HI4LVKWAYORE7SOAAZMVXDHI566JBSD25O5TRDM7LVID6YOXY/trades?cursor=77434489365606401-1&limit=10&order=asc'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/accounts/GABJBA4HI4LVKWAYORE7SOAAZMVXDHI566JBSD25O5TRDM7LVID6YOXY/trades?cursor=77434489365606401-1&limit=10&order=desc'
            }
          },
          _embedded: {
            records: [
              {
                _links: {
                  ...
                  seller: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GBDTBUKFHJOEAFAVNPGIY65CBIH75DYEZ5VQXOE7YHZM7AJKDNEOW5JG'
                  },
                  buyer: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GABJBA4HI4LVKWAYORE7SOAAZMVXDHI566JBSD25O5TRDM7LVID6YOXY'
                  },
                  operation: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/operations/77434489365606401'
                  }
                },
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GABJBA4HI4LVKWAYORE7SOAAZMVXDHI566JBSD25O5TRDM7LVID6YOXY/trades'
            )
          )
          .returns(Promise.resolve({ data: tradesResponse }));
      ...
      it('trades() requests the correct endpoint for paging', function(done) {
        let tradesResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=asc&limit=1&cursor=64199539053039617-0'
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=asc&limit=1&cursor=64199676491993090-0'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/trades?order=desc&limit=1&cursor=64199676491993090-0'
            }
          },
          _embedded: {
            records: [
              {
                _links: {
                  base: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GBBHSWC3XSUFKEFDPQO346BCLM3EAJHICWRVSVIQOG4YBIH3A2VCJ6G2'
                  },
                  counter: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/accounts/GDBXANSAUQ5WBFSA6LFQXR5PYVYAQ3T4KI4LHZ3YAAEFI3BS2Z3SFRVG'
                  },
                  operation: {
                    href:
                      'https://millennium-live.aiblocks.io:1337/operations/64199676491993090'
                  }
                },
    ...
    describe('StrictReceivePathCallBuilder', function() {
      ...
      it('requests the correct endpoint when source is an account', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/paths/strict-receive?source_account=GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP&destination_amount=20.0&destination_asset_type=credit_alphanum4&destination_asset_code=EUR&destination_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN'
            )
          )
      ...
      it('requests the correct endpoint when source is a list of assets', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              `https://millennium-live.aiblocks.io:1337/paths/strict-receive?source_assets=${destinationAssets}&destination_amount=20.0&destination_asset_type=credit_alphanum4&destination_asset_code=EUR&destination_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN`
            )
          )
          .returns(Promise.resolve({ data: pathsResponse }));
    ...
    describe('PathStrictSendCallBuilder', function() {
      ...
      it('requests the correct endpoint when destination is account', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/paths/strict-send?source_asset_type=credit_alphanum4&source_asset_code=EUR&source_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN&source_amount=20.0&destination_account=GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V'
            )
          )
          .returns(Promise.resolve({ data: pathsResponse }));
      ...
      it('requests the correct endpoint when destination is a list of assets', function(done) {
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              `https://millennium-live.aiblocks.io:1337/paths/strict-send?source_asset_type=credit_alphanum4&source_asset_code=EUR&source_asset_issuer=GDSBCQO34HWPGUGQSP3QBFEXVTSR2PW46UIGTHVWGWJGQKH3AFNHXHXN&source_amount=20.0&destination_assets=${destinationAssets}`
            )
          )
          .returns(Promise.resolve({ data: pathsResponse }));
    ...
    describe('EffectCallBuilder', function() {
      ...
      it('requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/effects?cursor=b'
            )
          )
      ...
      it('forAccount() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GCGHCFUB6JKQE42C76BK2LYB3EHKP4WQJE624WTSL3CU2PPDYE5RBMJE/effects'
            )
          )
          .returns(Promise.resolve({ data: effectsResponse }));
      ...
      it('forTransaction() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/transactions/ef37d6770c40c3bdb6adba80759f2819971396d1c3dfb7b5611f63ad72a9a4ae/effects'
            )
          )
          .returns(Promise.resolve({ data: effectsResponse }));
    ...
    describe('OperationCallBuilder', function() {
      ...
      it('operation() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/operations/123456789'
            )
          )
      ...
      it('forAccount() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GCGHCFUB6JKQE42C76BK2LYB3EHKP4WQJE624WTSL3CU2PPDYE5RBMJE/operations'
            )
          )
          .returns(Promise.resolve({ data: operationsResponse }));
      ...
      it('forLedger() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/ledgers/123456789/operations'
            )
          )
          .returns(Promise.resolve({ data: operationsResponse }));
      ...
      it('forTransaction() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/transactions/blah/operations'
            )
          )
          .returns(Promise.resolve({ data: operationsResponse }));
    ...
    describe('PaymentCallBuilder', function() {
      ...
      it('forAccount() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/payments'
            )
          )
      ...
      it('forLedger() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/ledgers/123456789/payments'
            )
          )
          .returns(Promise.resolve({ data: paymentsResponse }));
      ...
      it('forTransaction() requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/transactions/77277606902d80a03a892536ebff8466726a4e55c3923ec2d3eeb3aa5bdc3731/payments'
            )
          )
          .returns(Promise.resolve({ data: paymentsResponse }));
    ...
    describe('FriendbotCallBuilder', function() {
      ...
      it('requests the correct endpoint', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/friendbot?addr=GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K'
            )
          )
    ...
    describe('TradeAggregationCallBuilder', function() {
      let tradeAggregationResponse = {
        _links: {
          self: {
            href:
              'https://millennium.aiblocks.io/trade_aggregations?base_asset_type=native\u0026counter_asset_type=credit_alphanum4\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026start_time=1512689100000\u0026end_time=1512775500000\u0026resolution=300000'
          },
          next: {
            href:
              'https://millennium.aiblocks.io/trade_aggregations?base_asset_type=native\u0026counter_asset_code=BTC\u0026counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH\u0026counter_asset_type=credit_alphanum4\u0026end_time=1512775500000\u0026resolution=300000\u0026start_time=1512765000000'
          },
          prev: {
            href: ''
          }
      ...
      it('requests the correct endpoint native/credit', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/trade_aggregations?base_asset_type=native&counter_asset_type=credit_alphanum4&counter_asset_code=BTC&counter_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH&start_time=1512689100000&end_time=1512775500000&resolution=300000'
            )
          )
      ...
      it('requests the correct endpoint credit/native', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/trade_aggregations?base_asset_type=credit_alphanum4&base_asset_code=BTC&base_asset_issuer=GATEMHCCKCY67ZUCKTROYN24ZYT5GK4EQZ65JJLDHKHRUZI3EUEKMTCH&counter_asset_type=native&start_time=1512689100000&end_time=1512775500000&resolution=300000'
            )
          )
          .returns(Promise.resolve({ data: tradeAggregationResponse }));
    ...
    describe('AssetsCallBuilder', function() {
      it('requests the correct endpoint', function(done) {
        let assetsResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=asc\u0026limit=1\u0026cursor='
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=asc\u0026limit=1\u0026cursor=9MILLENNIUMS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=desc\u0026limit=1\u0026cursor=9MILLENNIUMS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12'
            }
          },
          _embedded: {
            records: [
              {
                ...
                asset_code: '9MILLENNIUMS',
                asset_issuer:
                  'GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW',
                paging_token:
                  '9MILLENNIUMS_GB2HXY7UEDCSHOWZ4553QFGFILNU73OFS2P4HU5IB3UUU66TWPBPVTGW_credit_alphanum12',
        ...
        this.axiosMock
          .expects('get')
          .withArgs(
            sinon.match('https://millennium-live.aiblocks.io:1337/assets?limit=1')
          )
      ...
      it('requests the correct endpoint (asset_code)', function(done) {
        let assetsCodeResponse = {
          _links: {
            self: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=asc\u0026limit=1\u0026cursor=\u0026asset_code=USD'
            },
            next: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=asc\u0026limit=1\u0026cursor=USD_GCYK67DDGBOANS6UODJ62QWGLEB2A7JQ3XUV25HCMLT7CI23PMMK3W6R_credit_alphanum4\u0026asset_code=USD'
            },
            prev: {
              href:
                'https://millennium-live.aiblocks.io:1337/assets?order=desc\u0026limit=1\u0026cursor=USD_GCYK67DDGBOANS6UODJ62QWGLEB2A7JQ3XUV25HCMLT7CI23PMMK3W6R_credit_alphanum4\u0026asset_code=USD'
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/assets?asset_code=USD&limit=1'
            )
          )
      ...
      it('requests the correct endpoint (asset_issuer)', function(done) {
        let assetIssuerResponse = {
          _links: {
            self: {
              href:
                'http://millennium-testnet.aiblocks.io:1337/assets?order=asc\u0026limit=10\u0026cursor=\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN'
            },
            next: {
              href:
                'http://millennium-testnet.aiblocks.io:1337/assets?order=asc\u0026limit=10\u0026cursor=00acc1_GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN_credit_alphanum12\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN'
            },
            prev: {
              href:
                'http://millennium-testnet.aiblocks.io:1337/assets?order=desc\u0026limit=10\u0026cursor=004d40_GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN_credit_alphanum12\u0026asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN'
            }
          },
          _embedded: {
            records: [
        ...
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/assets?asset_issuer=GCOGPF7IRVXUCJZAQWXVFQEE4HAOCTDGZI2QZSMKLM5BTTGRLY6GDOJN&limit=1'
            )
          )
      ...
      let assetCodeIssuerResponse = {
        _links: {
          self: {
            href:
              'http://millennium-testnet.aiblocks.io/assets?order=asc\u0026limit=10\u0026cursor=\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR'
          },
          next: {
            href:
              'http://millennium-testnet.aiblocks.io/assets?order=asc\u0026limit=10\u0026cursor=USD_GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR_credit_alphanum4\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR'
          },
          prev: {
            href:
              'http://millennium-testnet.aiblocks.io/assets?order=desc\u0026limit=10\u0026cursor=USD_GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR_credit_alphanum4\u0026asset_code=USD\u0026asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR'
          }
        },
        _embedded: {
          records: [
            {
              _links: {
                toml: {
                  href: 'https://bakalr/.well-known/aiblocks.toml'
                }
              },
              asset_type: 'credit_alphanum4',
              asset_code: 'USD',
      ...
      it('requests the correct endpoint (asset_code then asset_issuer)', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/assets?asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR&asset_code=USD'
            )
          )
      ...
      it('requests the correct endpoint (asset_issuer then asset_code)', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/assets?asset_code=USD&asset_issuer=GBW3EZBZKRERB4JUDWGQPIBGHKJ4XPOFG2VQ2WTFR4F7TYC5WS7F3XGR'
            )
          )
          .returns(Promise.resolve({ data: assetCodeIssuerResponse }));
    ...
    describe('Regressions', function() {
      it('offers callBuilder does not pollute Server instance URI #379', function(done) {
        this.axiosMock
          ...
          .withArgs(
            sinon.match(
              'https://millennium-live.aiblocks.io:1337/accounts/GBS43BF24ENNS3KPACUZVKK2VYPOZVBQO2CISGZ777RYGOPYC2FT6S3K/effects'
            )
          )
          .returns(Promise.resolve({ data: {} }));
