describe('server.js transaction tests', function() {
  ...
  it('sends a transaction', function(done) {
    this.axiosMock
      .expects('post')
      .withArgs(
        'https://millennium-live.aiblocks.io:1337/transactions',
        `tx=${this.blob}`
      )
  ...
  it('adds metadata - tx was too small and was immediately deleted', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/db2c69a07be57eb5baefbfbb72b95c7c20d2c4d6f2a0e84e7c27dd0359055a2f'
        }
      },
  ...
  it('adds metadata, order immediately fills', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/d88ded94c558790f7e819b85fd35adb10a1e474312c34ebd611495c349a8eb69'
        }
      },
  ...
  it('adds metadata, order is open', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/e1c2b91141d8c4185dc8c18118f345a269d88c476bdadec695c1b3ecdc999831'
        }
      },
  ...
  it('adds metadata, partial fill', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/28552ba6a70ab74f6de05319950e2ddad94491159ebc97b14cfcde2d3c7e70a1'
        }
      },
  ...
  it('doesnt add metadata to non-offers', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/6c3191f252f2c586c74275c766ce761021513e520eab3bb63d3fd18d0d01492e'
        }
      },
  ...
  it('adds metadata about offers, even if some ops are not', function(done) {
    const response = {
      _links: {
        transaction: {
          href:
            'https://millennium.aiblocks.io/transactions/6a22d6896140f6f330ef19086827df0780eb2ad3324f3271b38c70cb1cba1c3d'
        }
      },
  ...
  it('checks for memo required by default', function(done) {
    ...
    this.axiosMock.expects("get") 
      .withArgs(
        sinon.match(
          'https://millennium-live.aiblocks.io:1337/accounts/GASOCNHNNLYFNMDJYQ3XFMI7BYHIOCFW3GJEOWRPEGK2TDPGTG2E5EDW'
        )
      )
  ...
  it('submits fee bump transactions', function(done) {
    const feeBumpTx = AiBlocksSdk.TransactionBuilder.buildFeeBumpTransaction(
      keypair,
      '200',
      this.transaction,
