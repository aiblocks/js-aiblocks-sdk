 ...
 *
 * @see [All Operations](https://www.aiblocks.io/developers/millennium/reference/endpoints/operations-all.html)
...
> {
   ...
   * @see [Operation Details](https://www.aiblocks.io/developers/millennium/reference/endpoints/operations-single.html)
   ...
   * @see [Operations for Account](https://www.aiblocks.io/developers/millennium/reference/endpoints/operations-for-account.html)
   ...
   *
   * @see [Operations for Ledger](https://www.aiblocks.io/developers/millennium/reference/endpoints/operations-for-ledger.html)
   ...
   * @see [Operations for Transaction](https://www.aiblocks.io/developers/millennium/reference/endpoints/operations-for-transaction.html)
