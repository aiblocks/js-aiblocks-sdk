...
/**
 * The AiBlocks Network allows payments to be made across assets through path payments. A path payment specifies a
 ...
 *
 * As part of the search, millennium will load a list of assets available to the source address and will find any
