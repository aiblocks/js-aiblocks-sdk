 ...
 * @extends CallBuilder
 * @see [All Transactions](https://www.aiblocks.io/developers/millennium/reference/endpoints/transactions-all.html)
 * @constructor
...
> {
   ...
   * @see [Transaction Details](https://www.aiblocks.io/developers/millennium/reference/endpoints/transactions-single.html)
   ...
   * @see [Transactions for Account](https://www.aiblocks.io/developers/millennium/reference/endpoints/transactions-for-account.html)
   ...
   * @see [Transactions for Ledger](https://www.aiblocks.io/developers/millennium/reference/endpoints/transactions-for-ledger.html)
