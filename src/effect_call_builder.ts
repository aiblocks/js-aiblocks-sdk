 ...
 * @extends CallBuilder
 * @see [All Effects](https://www.aiblocks.io/developers/millennium/reference/endpoints/effects-all.html)
 * @constructor
...
> {
   ...
   * @see [Effects for Account](https://www.aiblocks.io/developers/millennium/reference/endpoints/effects-for-account.html)
   ...
   * @see [Effects for Ledger](https://www.aiblocks.io/developers/millennium/reference/endpoints/effects-for-ledger.html)
   ...
   * @see [Effects for Transaction](https://www.aiblocks.io/developers/millennium/reference/endpoints/effects-for-transaction.html)
   ...
   * @see [Effects for Operation](https://www.aiblocks.io/developers/millennium/reference/endpoints/effects-for-operation.html)
