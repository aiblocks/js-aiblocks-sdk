 ...
 * @see [All Payments](https://www.aiblocks.io/developers/millennium/reference/endpoints/payments-all.html)
 * @constructor
 * @extends CallBuilder
...
> {
   ...
   * @see [Payments for Account](https://www.aiblocks.io/developers/millennium/reference/endpoints/payments-for-account.html)
   ...
   * @see [Payments for Ledger](https://www.aiblocks.io/developers/millennium/reference/endpoints/payments-for-ledger.html)
   ...
   * @see [Payments for Transaction](https://www.aiblocks.io/developers/millennium/reference/endpoints/payments-for-transaction.html)
