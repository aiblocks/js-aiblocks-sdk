 ...
 * @extends CallBuilder
 * @constructor
 * @see [Trades](https://www.aiblocks.io/developers/millennium/reference/endpoints/trades.html)
 * @param {string} serverUrl serverUrl Millennium server URL.
 */
...
> {
   ...
   * @see [Trades for Account](https://www.aiblocks.io/developers/millennium/reference/endpoints/trades-for-account.html)
